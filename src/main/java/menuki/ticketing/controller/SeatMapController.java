...
public class SeatMapController {
     ...
     */
    public void initForEvent(String eventId, String eventName) {

        if (this.seatService == null) {
            this.seatService = new JdbcSeatService();
        }
    ...
    private void onCheckout() {
        try {
            ...
            Event ev = new Event(this.eventId, this.eventName, null, null, null, null, 0);
